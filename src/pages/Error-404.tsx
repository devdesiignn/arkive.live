  ...
  return (
    <div className="w-full h-screen flex items-center justify-center text-center selection:bg-black selection:text-white">
      <div className="flex flex-col items-center gap-4 sm:gap-8 lg:gap-12 w-11/12 mx-auto">
        <h1 className="flex text-7xl sm:text-8xl lg:text-9xl items-center gap-1 leading-[normal] font-black select-none">
        ...
        <Link
          to="/auth/login"
          className="text-xl sm:text-2xl lg:text-3xl underline hover:no-underline flex items-center"
        >
